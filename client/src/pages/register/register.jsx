...
import { EmailValidate, PasswordValidate, ProfileValidate, fullNameValidate, userNameValidate } from '../../utils/validation/RegisterValidate.jsx';
import "./register.css";
...
const Register = () => {
    ...
    const RegisterUsers = async (item) => {
        ...
        axios.post(USERS.REGISTER_USER_API, formData, {
            headers: {
    ...
    return (
        regiLoading ? <h1>Plz wait for a while....</h1> :
                            ...
                            <section className="w-full flex flex-col md:flex-row items-center">
                                ...
                                <div className="bg-white w-full sm:max-w-md md:max-w-md lg:max-w-full md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
                                    ...
                                    <div className="w-full h-100">
                                        ...
                                        <h1 className="text-xl md:text-2xl font-bold leading-tight mt-3">Create new account </h1>
                                        ...
                                        <form className="mt-3" onSubmit={handleSubmit(RegisterUsers)}>
                                            ...
                                            {errors.profileImage && <p className="errorMsg">{errors.profileImage.message}</p>}
                                        ...
                                        px-4 py-2.5 mt-6"> Register User</Button>

                                        </form>

                                        {/* <hr className="my-6  border-gray-300 w-full" /> */}

                                        <p className="mt-4">Already have account? <NavLink to="/login" className="text-blue-500 hover:text-blue-700 font-semibold">Please Login</NavLink></p>
