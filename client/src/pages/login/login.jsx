...
import { EmailValidate, PasswordValidate } from '../../utils/validation/RegisterValidate.jsx';
...
const Login = () => {
    ...
    const LoginUser = async (logData) => {
        ...
        const res = await axios.post("http://localhost:5000/api/v1/user/login", logData);
        console.log("res", res);
                ...
                loading ? <h1>`Loading Data..............................` </h1> : <>
                    {
                        <>
                            <section className="w-full flex flex-col md:flex-row items-center">
                                ...
                                <div className="bg-white w-full sm:max-w-md md:max-w-md lg:max-w-full md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
                                    ...
                                    <div className="w-full h-100">
                                        ...
                                        <form className="mt-6" onSubmit={handleSubmit(LoginUser)}>
                                            ...
                                            <div className="text-right mt-2">
                                                <Link to="/login" className="text-sm font-semibold text-gray-700 hover:text-blue-700 focus:text-blue-700">Forgot Password?</Link>
                                            </div>
                                        ...
                                        <button onClick={() => window.location.href = 'http://localhost:5000/api/v1/user/google'} className="w-full block bg-gray-200 hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-2.5 border border-gray-300">
                                            <div className="flex items-center justify-center">
                                                ...
                                                <img src='https://cdn.iconscout.com/icon/free/png-256/free-google-152-189813.png' alt='gogle' height="35px" width="35px" />
                                                <span className="ml-4">
                                                    Log in with Google</span>
                                            </div>
                                        </button>

                                        <p className="mt-8">Need an account? <NavLink to="/register" className="text-blue-500 hover:text-blue-700 font-semibold">Create an
                                            account</NavLink></p>

                                        <p className="text-sm text-gray-500 mt-12">&copy; {new Date().getFullYear()} Jenish Pvt-Ltd - All Rights Reserved.</p>
                                    </div>
                                </div>
